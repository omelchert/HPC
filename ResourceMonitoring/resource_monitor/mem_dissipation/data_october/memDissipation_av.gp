...
unset xlabel
p '../data_august/MPCS_memDissipation_average.dat' u 1:3 w l ls 1\
, '../data_september/MPCS_memDissipation_average.dat' u 1:3 w l ls 1\
, './MPCS_memDissipation_average.dat' u 1:3 w l ls 2
unset title
...
set ylabel "{/Times-Italic m_a}-{/Times-Italic m_u} (in G)"
set ytics 0,1,4
p '../data_august/MPCS_memDissipation_average.dat' u 1:5 w l ls 1 \
, '../data_september/MPCS_memDissipation_average.dat' u 1:5 w l ls 1 \
, './MPCS_memDissipation_average.dat' u 1:5 w l ls 1
